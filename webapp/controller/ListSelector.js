sap.ui.define([
	...
	return BaseObject.extend("com.sap.build.sap.faultyAddresses.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias com.sap.build.sap.faultyAddresses.model.ListSelector
		 */
		 ...
		 * @return {com.sap.build.sap.faultyAddresses.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
